...
extern bool_t  nav_photogrammetry2(void);

#define PhotogrammetryInitDefault(_wp1, _nr_of_wp) nav_photogrammetry_init( _wp1, _nr_of_wp, 0.8f, 0.8f, 70.0f, 35.0f);
#define PhotogrammetryInit(_wp1, _nr_of_wp, _overlap, _sidelap, _wind_threshold, _block_margin, _new_block) nav_photogrammetry_init(_wp1, _nr_of_wp, _overlap, _sidelap, _wind_threshold, _block_margin, _new_block)
#define PhotogrammetryInit_extra(_wp1, _overlap, _sidelap, _wind_threshold, _new_block) nav_photogrammetry_init_extra(_wp1, _overlap, _sidelap, _wind_threshold, _new_block)

#define Photogrammetry() nav_photogrammetry()
#define Photogrammetry_tri_bb() nav_photogrammetry_tri_bb()
#define Photogrammetry2() nav_photogrammetry2()
#endif
